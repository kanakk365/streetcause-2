...
export const FooterSection: React.FC = () => {
  ...
  const socialIcons = [
    {
      name: "X (Twitter)",
      icon: `<svg width="44" height="43" viewBox="0 0 44 43" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 2.75rem; height: 2.625rem; border-radius: 4.6875rem; background: rgba(255, 255, 255, 0.48); padding: 1.99025rem 2.042625rem; cursor: pointer">
    ...
    {
      name: "Twitter",
      icon: `<svg width="42" height="43" viewBox="0 0 42 43" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 2.75rem; height: 2.625rem; border-radius: 4.6875rem; background: rgba(255, 255, 255, 0.48); padding: 1.99025rem 2.042625rem; cursor: pointer">
    ...
    {
      name: "Facebook",
      icon: `<svg width="43" height="42" viewBox="0 0 43 42" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 2.75rem; height: 2.625rem; border-radius: 4.6875rem; background: rgba(255, 255, 255, 0.48); padding: 1.99025rem 2.042625rem; cursor: pointer">
  ...
  return (
    <footer className="w-full shadow-[0_1rem_4rem_0_rgba(255,255,255,0.25)] pt-20 pb-12 px-0 max-sm:pt-[3.75rem] max-sm:px-0 bg-[#082ca7]">
