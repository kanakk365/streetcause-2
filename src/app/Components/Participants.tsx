...
export const ParticipantsSection: React.FC = () => {
  ...
  return (
    <section className="px-0 py-20 max-sm:px-0 max-sm:py-[60px]">
      <header className="flex flex-col justify-center items-start gap-[30px] w-full max-w-[1074px] mt-0 mb-20 mx-auto px-5 py-0 max-sm:w-[95%] max-sm:mb-10 max-sm:px-5 max-sm:py-0">
      ...
      <div className="flex items-center justify-center gap-[30px] w-full max-w-[1200px] h-[100px] mx-auto my-0 px-5 py-0 max-lg:flex-wrap max-lg:gap-[20px] max-lg:h-auto max-lg:px-5 max-lg:py-0 max-sm:flex-col max-sm:gap-5 max-sm:px-5 max-sm:py-0">
        {participants.map((participant, index) => (
          <Image
            ...
            width={180}
            height={70}
            className="shadow-[0_4px_16px_0_rgba(0,0,0,0.25)] object-contain flex-shrink-0 max-lg:w-[150px] max-lg:h-[60px] max-sm:w-full max-sm:max-w-[180px] max-sm:h-14"
          />
        ))}
      </div>
    </section>
