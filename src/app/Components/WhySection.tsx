...
export const WhySection: React.FC = () => {
  return (
    <section className="w-full h-[476px] shadow-[0_4px_16px_0_rgba(255,255,255,0.25)] px-0 py-20 max-sm:h-auto max-sm:px-0 max-sm:py-[60px]  bg-gradient-to-b from-[#a00357] to-[#6b022e] ">
