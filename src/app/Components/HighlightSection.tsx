...
export const HighlightsSection: React.FC = () => {
  ...
  return (
    <section className="w-full h-[40rem] shadow-[0_1rem_4rem_0_rgba(255,255,255,0.25)] px-0 py-20 max-sm:h-auto max-sm:px-4 max-sm:py-16 bg-gradient-to-b from-[#a00357] to-[#6b022e]">
